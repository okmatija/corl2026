...
window.TRIP = {
  ...
  // Idea cards live in each plan (plans[].ideas). Fields: id, place (groups them on the Ideas page), title,
  // cat: nature | food | culture | music | city | night | adventure, cost, dur, why. Optional link: official website / booking page.
  ...
  plans: [
    {
      id: "vegas",
      label: "🎰 Vegas plan",
      // Idea cards for this plan (only places easily reached by car or train from its stops). Cards are per plan:
